...
function scheduleTrainingTargetRespawn(io, operations, campaignId, socketLog) {
  ...
  const timer = setTimeout(() => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${campaignId}`,'ops:contactAdded', { contact: trainingContact });
      broadcastStateChange(io, `ops:campaign:${campaignId}`,'ops:trainingTargetRespawned', { contact: trainingContact });
...
function register(ctx) {
  ...
  socket.on('ops:addContact', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:contactAdded', { contact });
  ...
  socket.on('ops:updateContact', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:contactUpdated', { contact });
  ...
  socket.on('ops:deleteContact', (data) => {
    try {
      ...
      if (deleted) {
        broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:contactDeleted', { contactId });
  ...
  socket.on('ops:scanContact', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:contactUpdated', { contact: disc.contact });
  ...
  socket.on('ops:authorizeWeapons', (data) => {
    try {
      ...
      // TODO: Emits { contactId, contactName, authorized, authorizedBy } but no client listens.
      // Client ops:weaponsAuthorized expects { contact, message } — shapes incompatible. (audit 2026-02-11)
      broadcastStateChange(io, `ops:bridge:${opsSession.shipId}`,'ops:weaponsAuthorizationChanged', {
        contactId,
  ...
  socket.on('ops:fireAtContact', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:bridge:${opsSession.shipId}`,'ops:weaponFired', {
  ...
  socket.on('ops:setEW', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:ewChanged', {
  ...
  socket.on('ops:setSensorLock', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:sensorLockChanged', {
        shipId: opsSession.shipId,
  ...
  socket.on('ops:setEnvironmentalData', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:environmentalData', environmentalData);
  ...
  socket.on('ops:clearEnvironmentalData', () => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:environmentalData', null);
  ...
  socket.on('ops:spawnJumpEmergence', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:jumpEmergence', {
  ...
  socket.on('ops:putOnViewscreen', (data) => {
    try {
      ...
      broadcastStateChange(io, `ops:campaign:${opsSession.campaignId}`,'ops:viewscreenFocus', {
        contactId,
