...
const WEAPONS = {
  beam_laser: { tl: 10, power: 4, damage: '1d6', cost: 500000, range: 'medium' },
  pulse_laser: { tl: 9, power: 4, damage: '2d6', cost: 1000000, range: 'long' },
  particle_beam: { tl: 12, power: 8, damage: '3d6', cost: 4000000, range: 'vlong' },
  plasma_gun: { tl: 11, power: 6, damage: '3d6', cost: 2500000, range: 'medium' },
  fusion_gun: { tl: 14, power: 12, damage: '4d6', cost: 2000000, range: 'medium' },
  railgun: { tl: 10, power: 2, damage: '2d6', cost: 1000000, range: 'short' },
  missile_rack: { tl: 7, power: 0, damage: '4d6', cost: 750000, range: 'special', ammo: 12 },
  sandcaster: { tl: 9, power: 0, damage: '0', cost: 250000, range: 'special', ammo: 20 }
};
