 ...
 *
 * @see lib/factories/NPCCrewFactory.js for NPC creation (Factory Pattern)
 */

const fs = require('fs');
const path = require('path');
const { db, generateId } = require('./database');
const { NPCCrewFactory } = require('../factories');
 ...
 * Delegates to NPCCrewFactory for consistent entity creation
 */
function generateDefaultNPCCrew(shipId, crewRequirements) {
  return NPCCrewFactory.createForShip(shipId, crewRequirements, generateId);
}
