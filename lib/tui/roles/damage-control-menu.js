 ...
 */
function handleDamageControlInput(session, key, setScreen) {
  ...
  if (key >= '1' && key <= '9') {
    ...
    showDamageControlMenu(session); // Refresh display
    return true;
  }
