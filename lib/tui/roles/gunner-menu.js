 ...
 */
function handleGunnerInput(session, key, setScreen) {
  ...
  if (key >= '1' && key <= '9') {
    ...
    showGunnerMenu(session); // Refresh display
    return true;
  }
