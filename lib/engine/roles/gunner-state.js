/**
 * AR-250: Gunner Role State
 *
 * Pure state extraction for gunner panel.
 * No HTML, no formatting - just structured data.
 *
 * @module lib/engine/roles/gunner-state
 */
 ...
 */
function calculateHitProbability2D6(totalDM) {
 ...
 */
function calculateHitChance(weapon, target, gunnerySkill = 0) {
 ...
 */
function getWeaponStatus(status) {
 ...
 */
function calculateTargetPriority(contact, hitChance) {
 ...
 */
function getThreatLevel(marking) {
 ...
 */
function getGunnerState(shipState, template, contacts, roleInstance = 1, shipWeapons = []) {
 ...
 */
function canEngageTarget(gunnerState) {
