#!/usr/bin/env node
/**
 * Sword Worlds Subsector (J) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/sword-worlds-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-j-sword-worlds.json');
