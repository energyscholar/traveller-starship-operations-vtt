#!/usr/bin/env node
/**
 * Querion Subsector (E) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/querion-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-e-querion.json');
