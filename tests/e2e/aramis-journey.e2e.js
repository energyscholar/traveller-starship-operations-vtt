#!/usr/bin/env node
/**
 * Aramis Subsector (H) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/aramis-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-h-aramis.json');
