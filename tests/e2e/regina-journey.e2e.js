#!/usr/bin/env node
/**
 * Regina Subsector (F) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/regina-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-f-regina.json');
