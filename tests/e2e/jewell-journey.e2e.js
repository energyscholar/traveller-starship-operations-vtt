#!/usr/bin/env node
/**
 * Jewell Subsector (B) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/jewell-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-b-jewell.json');
