#!/usr/bin/env node
/**
 * District 268 Subsector (N) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/district-268-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-n-district-268.json');
