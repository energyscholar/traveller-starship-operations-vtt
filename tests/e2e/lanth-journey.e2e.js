#!/usr/bin/env node
/**
 * Lanth Subsector (G) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/lanth-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-g-lanth.json');
