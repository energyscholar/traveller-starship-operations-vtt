#!/usr/bin/env node
/**
 * Rhylanor Subsector (D) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/rhylanor-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-d-rhylanor.json');
