#!/usr/bin/env node
/**
 * Glisten Subsector (O) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/glisten-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-o-glisten.json');
