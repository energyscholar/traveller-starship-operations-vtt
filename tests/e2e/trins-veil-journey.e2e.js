#!/usr/bin/env node
/**
 * Trin's Veil Subsector (P) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/trins-veil-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-p-trins-veil.json');
