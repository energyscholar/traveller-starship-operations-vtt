#!/usr/bin/env node
/**
 * Five Sisters Subsector (M) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/five-sisters-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-m-five-sisters.json');
