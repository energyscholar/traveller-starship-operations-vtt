#!/usr/bin/env node
/**
 * Vilis Subsector (C) Journey E2E Test
 *
 * Run with: npm run test:e2e tests/e2e/vilis-journey.e2e.js
 */
...
const subsectorPath = path.join(__dirname, '../../data/star-systems/spinward-marches/subsector-c-vilis.json');
